...
for f in bin en fr lib README.md scripts ; do ln -s $PWD/$f ../semantic_forms_cloned/$f ; echo ln -s $PWD/$f ../semantic_forms_cloned/$f ; done

for f in conf files ; do cp -r $f ../semantic_forms_cloned/ ; echo cp -r $f ../semantic_forms_cloned/ ; done
