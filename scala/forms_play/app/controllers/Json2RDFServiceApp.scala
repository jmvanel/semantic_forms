  ...
  with RDFStoreLocalJenaProvider
{
  def json2rdf() = Action { implicit request: Request[_] =>
    ...
    // TODO hard coded context URL
    val contextURL = "https://raw.githubusercontent.com/jmvanel/rdf-convert/master/geonature/context.jsonld"
    val options = new JsonLdOptions()
    options.setExpandContext(contextURL)
    // TODO be able to process media type 'text/plain' , use JsonDocument
