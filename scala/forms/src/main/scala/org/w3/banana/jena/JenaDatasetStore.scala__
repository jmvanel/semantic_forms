...
class JenaDatasetStore(defensiveCopy: Boolean=false)
(implicit ops: RDFOps[Jena], jenaUtil: JenaUtil)
extends RDFStore[Jena] with SparqlUpdate
with Transactor[Jena, Dataset] {
